...
import '../aa_models/map/map_action.dart';
...
class FlutterAndroidAutoController {
  ...
  void processFAAMapActionPressedChannel(String elementId) {
    final AAMapAction? action = _androidAutoHelper.findAAMapAction(
      templates: templateHistory,
      elementId: elementId,
    );
    action?.onPress?.call();
