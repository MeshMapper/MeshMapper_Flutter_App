...
class ExternalSurfaceColor {
  const ExternalSurfaceColor(this.r, this.g, this.b);

  factory ExternalSurfaceColor.fromColor(Color color) => ExternalSurfaceColor(
