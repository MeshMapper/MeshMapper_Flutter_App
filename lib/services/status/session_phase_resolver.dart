...
@visibleForTesting
String gpsPhaseLabel(GpsStatus status) => _gpsLabel(status);

String _gpsLabel(GpsStatus status) => switch (status) {
  ...
  required String modeTitle,
    ...
    if (isZoneTransferInProgress) {
      return (
        ...
        detail: [zoneTransferFrom, zoneTransferTo]
            .whereType<String>()
            .join(' → '),
        endsAt: null,
      );
